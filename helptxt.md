...
- `ctp` Count Tabs in Private windows
...
- `yM` yank page URL/title as Markdown link
- `yC` yank page URL/title as CSV
- `yJ` yank page URL/title as JSON
- `yAU` yank All tabs URLs
- `yAM` yank All tabs URLs/titles as Markdown link
- `yAC` yank All tabs URLs/titles to CSV
- `yAJ` yank All tabs URLs/titles as JSON
- `yPU` yank Private tabs URLs
- `yPM` yank Private tabs URLs/titles as Markdown link
- `yPC` yank Private tabs URLs/titles to CSV
- `yPJ` yank Private tabs URLs/titles as JSON
- `yWU` yank Window tabs URLs
- `yWM` yank Window tabs as Markdown links
- `yWC` yank Window tabs as CSV
- `yWJ` yank Window tabs as JSON
